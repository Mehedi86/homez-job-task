        ...
        <div className='bg-white py-20'>
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='grid md:grid-cols-2 gap-4 my-6 px-2 lg:px-0'>
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='h-[200px] md:h-[220px] lg:h-[270px]'>
                            <img className='w-full h-full object-cover rounded-lg' src="/images/explore-apartment/townhome.png" alt="" />
                        </div>
                        <div className='h-[200px] md:h-[220px] lg:h-[270px]'>
                            <img className='w-full h-full object-cover rounded-lg' src="/images/explore-apartment/villa.png" alt="" />
                        </div>
                    </div>
                    <div className='h-[200px] md:h-[220px] lg:h-[270px]'>
                        <img className='w-full h-full object-cover rounded-lg' src="/images/explore-apartment/banglow.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
